...
import net.moistti.nether_depths.block.entity.AbstractForgeBlockEntity;
import org.jetbrains.annotations.Nullable;

public abstract class AbstractForgeBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    @Nullable
    protected static <T extends BlockEntity> BlockEntityTicker<T> checkType(World world, BlockEntityType<T> givenType, BlockEntityType<? extends AbstractForgeBlockEntity> expectedType) {
        return world.isClient ? null : AbstractForgeBlock.checkType(givenType, expectedType, AbstractForgeBlockEntity::tick);
    }
    @Override
